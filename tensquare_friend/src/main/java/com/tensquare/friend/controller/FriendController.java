...
// http://127.0.0.1:9008/user/login?mobile=18838988676&password=123  获得 token
//

    @PutMapping("/test/{friendId}")
    public Result testUser(@PathVariable String friendId){
        System.out.println("id:"+friendId);
        Result result= userClient.testTensquareUser(friendId);
        return  result;
    }
